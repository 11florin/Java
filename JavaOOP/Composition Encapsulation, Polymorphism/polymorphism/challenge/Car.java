...
public class Car {
    ...
    public void startEngine() {
        System.out.println("Car -> startsEngine");
    }
...
class GasPoweredCar extends Car {
    ...
    protected void runEngine() {
        super.runEngine();
        System.out.printf("Gas -> usage exceeds tehe average: %.2f %n", avgKmPerLiter);
    }
...
class ElectricCar extends Car {
    ...
    @Override
    public void startEngine() {
        System.out.printf("BEV -> switch %d kWh bettery on, Ready!%n", batterySize);
    }
    @Override
    protected void runEngine() {
...
class HybridCar extends Car {
    ...
    public void startEngine() {
        ...
        System.out.printf("Hybrid -> switch %d kWh bettery on, Ready!%n", batterySize);
    }
    @Override
    protected void runEngine() {
